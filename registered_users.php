...
$query="SELECT username, email , phone_number FROM users where role='user'";
...
<ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuLink">
    ...
    <a href="registered_users.php" class="active"><i class="fas fa-users"></i> Users</a>
...
<div class="main-content container mt-5">
    ...
    <h2 class="text-center mb-4"><b>Registered Users</b></h2>
