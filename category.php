...
// Fetch categories
$categories = $conn->query("SELECT * FROM vehicle_categories");
...
<ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuLink">
    ...
    <a href="category.php" class="active"><i class="fas fa-th-list"></i> Category</a>
...
<div class="container mt-5">
    <h2 class="text-center">Add Vehicle Category</h2>
    <form method="POST" class="d-flex mb-4">
        <input class="form-control me-2" type="text" name="category" placeholder="Enter Category" required>
        <button type="submit" name="add_category" class="btn btn-primary">Add</button>
    </form>

    <h3 class=" h-4 text-center">Existing Categories</h3>
        ...
        <tbody>
            <?php while ($row = $categories->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="category.php?delete_id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
